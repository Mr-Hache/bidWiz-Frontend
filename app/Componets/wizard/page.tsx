...
//   };
  ...
  //   const decimalStars = numStars - fullStars;
  //   const stars = '⭐';
  //   const emptyStar = '☆';
  
  //   let starString = stars.repeat(fullStars);
  
  //   if (decimalStars > 0) {
  //     const fractionalStar = getFractionalStar(decimalStars, emptyStar);
  //     starString += fractionalStar;
  //   }
  
  //   return starString;
  // };
  
  // const getFractionalStar = (decimalStars: number, emptyStar: string) => {
  //   const fractionalCharacters = [
  //     '', '½', '⅓', '¼', '⅕'
  //   ];
  
  //   const fractionalIndex = Math.round(decimalStars * (fractionalCharacters.length - 1));
  //   const fractionalCharacter = fractionalCharacters[fractionalIndex];
  
  //   if (fractionalCharacter === '½') {
  //     return fractionalCharacter;
  //   }
  
  //   const emptyFractionalStar = emptyStar + fractionalCharacter;
  //   return emptyFractionalStar;
  // };
